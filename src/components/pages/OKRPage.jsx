...
const GOALS = [
  {
    id: 'g1',
    title: 'הכשרת תלמידים כסוכני בינה',
    color: {
    ...
    krs: [
      { id: 'g1k1', label: '5 מפגשי השראה' },
      { id: 'g1k2', label: '5 מפגשים לימוד ותרגול' },
      { id: 'g1k3', label: 'כולם עוברים מבחן הסמכה' },
      { id: 'g1k4', label: 'כולם מציגים פרזנטציה אישית להדגמת יכולות' },
    ],
  },
  {
    id: 'g2',
    title: 'יצירת תוצרים איכותיים והוצאתם לפועל',
    color: {
    ...
    krs: [
      { id: 'g2k1', label: 'שלושה שת"פים שונים עם מורים' },
      { id: 'g2k2', label: '50% מהתלמידים הכיתה עשו שימוש בתוצר' },
      { id: 'g2k3', label: 'מורים/כיתות אחרות מבקשות להשתמש בתוצר' },
      { id: 'g2k4', label: 'תיק עבודות אישי לכל סוכן' },
    ],
  },
  {
    id: 'g3',
    title: 'שיתוף פעולה פורה עם מורים',
    color: {
    ...
    krs: [
      { id: 'g3k1', label: 'כלל מורי בית הספר מכירים את הקונספט של הנבחרת' },
      { id: 'g3k2', label: '40 מורים ענו על סקר מיקוד צרכים' },
      { id: 'g3k3', label: '10 מורים מקיימים אינטראקציות עם הסוכנים' },
      { id: 'g3k4', label: 'נוצר מאגר מידע רחב עם תובנות מורים לגבי הפעילות' },
    ],
  },
  {
    id: 'g4',
    title: 'מיצוב הנבחרת כמיישם מצליח',
    color: {
    ...
    krs: [
      { id: 'g4k1', label: 'שביעות רצון גבוהה בשאלונים מצד הנהלה, מורים וסוכנים' },
      { id: 'g4k2', label: "ביקוש גבוה להצטרפות למחזור ב'" },
      { id: 'g4k3', label: 'התעניינות מצד בתי ספר אחרים' },
      { id: 'g4k4', label: 'כתבה אוהדת במקור תקשורת כלשהו' },
    ],
  },
]
